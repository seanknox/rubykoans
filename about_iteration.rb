...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject will combine all elements in an enumerable.
    # argument is the starting value of the block
  ...
  # sk 20130216: by passing in the file into a block, each line can be 
  # iterated over.
